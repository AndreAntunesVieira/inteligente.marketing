              ...
              <div className="single-post-wrapper">
                ...
                <div className="row post-share-links d-flex align-items-center">
                  ...
                  <div className="col-md-9 col-xl-8 post-tags-list">
                    <span>
                      <a href="src/pages/single-post#">Life</a>
                    </span>
                    <span>
                      <a href="src/pages/single-post#">Ideas</a>
                    </span>
                    <span>
                      <a href="src/pages/single-post#">Story</a>
                    </span>
                    <span>
                      <a href="src/pages/single-post#">Web Design</a>
                    </span>
                  </div>
                  {/* POST SHARE ICONS */}
                  <div className="col-md-3 col-xl-4 post-share-list text-end">
                    <ul className="share-social-icons ico-25 text-center clearfix">
                      <li>
                        <a href="src/pages/single-post#" className="share-ico">
              ...
              <div className="author-senoff">
                ...
                <div className="author-senoff-txt">
                  ...
                  <p className="author-link">
                    All stories by <a href="src/pages/single-post#">Matthew Anderson</a>
                  </p>
                  {/* Follow Button */}
                  <div className="author-follow-btn">
                    <a href="src/pages/single-post#">Follow</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="comment-body">
                    ...
                    <div className="comment-meta">
                      ...
                      <span className="btn-reply ico-20">
                        <a href="src/pages/single-post#leave-comment">
