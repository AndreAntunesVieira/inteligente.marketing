...
const Bloglisting = () => {
  ...
  return (
    <Layout btnCustomHover="btn btn-skyblue tra-grey-hover last-link" singlePage>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-7 blog-post-img">
                <div className="hover-overlay">
                  <img className="img-fluid" src="/images/blog/featured-post.jpg" alt="blog-post-image" />
              ...
              <div className="col-lg-5 blog-post-txt">
                ...
                <h5 className="h5-xl">
                  <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
                    <a>Tempor sapien donec gravida a suscipit and porta justo vitae</a>
                  </Link>
                </h5>
                {/* Text */}
                <p className="p-lg">
                  Aliqum mullam blandit vitae tempor sapien and donec lipsum gravida and porta undo velna dolor in
                  cubilia...
                </p>
                {/* Post Meta */}
                ...
                <div className="masonry-wrap grid-loaded">
                  ...
                  <div className="blog-3-post masonry-image">
                    ...
                    <div className="blog-post-txt">
                      {/* Post Tag */}
                      <p className="p-md post-tag">OLMO News  |  JuLy 31, 2021</p>
                      {/* Post Link */}
                      <h5 className="h5-md">
                        <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
                          <a>A ligula risus auctor and tempus sapien an augue integer turpis</a>
                        </Link>
                      </h5>
                      {/* Post Meta */}
                      <div className="post-meta">
                  ...
                  <div className="blog-3-post masonry-image">
                    ...
                    <div className="blog-post-txt">
                      {/* Post Tag */}
                      <p className="p-md post-tag">Tutorials  |  JuLy 24, 2021</p>
                      {/* Post Link */}
                      <h5 className="h5-md">
                        <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
                          <a>Integer urna turpis donec ipsum a porta justo risus auctor mauris augue</a>
                        </Link>
                      </h5>
                      {/* Post Meta */}
                      <div className="post-meta">
                  ...
                  <div className="blog-3-post masonry-image">
                    ...
                    <div className="blog-post-txt">
                      {/* Post Tag */}
                      <p className="p-md post-tag">Inspiration  |  JuLy 06, 2021</p>
                      {/* Post Link */}
                      <h5 className="h5-md">
                        <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
                  ...
                  <div className="blog-3-post masonry-image">
                    ...
                    <div className="blog-post-txt">
                      {/* Post Tag */}
                      <p className="p-md post-tag">OLMO News  |  June 30, 2021</p>
                      {/* Post Link */}
                      <h5 className="h5-md">
                        <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
                  ...
                  <div className="blog-3-post masonry-image">
                    ...
                    <div className="blog-post-txt">
                      {/* Post Tag */}
                      <p className="p-md post-tag">Inspiration  |  June 18, 2021</p>
                      {/* Post Link */}
                      <h5 className="h5-md">
                        <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
                  ...
                  <div className="blog-3-post masonry-image">
                    ...
                    <div className="blog-post-txt">
                      {/* Post Tag */}
                      <p className="p-md post-tag">OLMO News  |  June 25, 2021</p>
                      {/* Post Link */}
                      <h5 className="h5-md">
                        <Link href="/Users/andre/projects/inteligente.marketing.site/src/pages/single-post">
              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination ico-20 justify-content-center">
                  <li className="page-item disabled">
                    <a className="page-link" href="src/pages/blog-listing#" tabIndex={-1}>
                      <span className="flaticon-back" />
                    </a>
                  </li>
                  <li className="page-item active" aria-current="page">
                    <a className="page-link" href="src/pages/blog-listing#">
                      1
                    </a>
                  </li>
                  ...
                  <li className="page-item">
                    <a className="page-link" href="src/pages/blog-listing#" aria-label="Next">
      ...
      {/* NEWSLETTER-1
			============================================= */}
      <section id="newsletter-1" className="bg-snow newsletter-section division">
        <div className="container">
