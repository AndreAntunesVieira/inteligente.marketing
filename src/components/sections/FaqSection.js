...
const FaqSection = ({ title, text, items = [] }) => {
  ...
  return (<section id="faqs-2" className="wide-60 faqs-section division">
        ...
        <div className="row row-cols-1 row-cols-lg-2">
          <div className="col">
            <div className="questions-holder pr-15">
              {questionHolders[0].map(item => (<div className="question wow fadeInUp">
                {/* Question */}
                <h5 className="h5-md">
                  {item.question}
                </h5>
          ...
          <div className="col">
            <div className="questions-holder pl-15">
              {questionHolders[1].map(item => (<div className="question wow fadeInUp">
                {/* Question */}
                <h5 className="h5-md">
                  {item.question}
                </h5>
