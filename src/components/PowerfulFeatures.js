      ...
      <div className={`container ${noBg ? '' : 'white-color'}`}>
        ...
        <div className="row justify-content-center">
          <div className="col-md-10 col-lg-8">
            <div className="section-title title-02 mb-60">
              {sync && (
                <span className="section-id rounded-id bg-tra-purple purple-color txt-upcase">Sync Across Devices</span>
              )}
        ...
        <div className="row">
          <div className="col">
            <div
              className={`${
                noBg ? 'img-block text-center video-preview wow fadeInUp' : 'content-9-img video-preview wow fadeInUp'
              }`}
            >
              {/* Play Icon */}
