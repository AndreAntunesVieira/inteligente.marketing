                ...
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg tm-social">
                      <a href="src/pages/team#" className="text-secondary">
                        @jonatanbarnes
                      </a>
                    </p>
                  </div>
                ...
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg tm-social text-secondary">
                      <a href="src/pages/team#">@jamiebartlett</a>
                    </p>
                  </div>
                </div>
              </div>{' '}
              ...
              <div className="col">
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg">Software Engineer</p>
                    <p className="p-lg tm-social text-secondary">
                      <a href="src/pages/team#">@matthewanderson</a>
                    </p>
                  </div>
                </div>
              </div>{' '}
              ...
              <div className="col">
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg tm-social text-secondary">
                      <a href="src/pages/team#">@megancoleman</a>
                    </p>
                  </div>
                </div>
              </div>{' '}
              ...
              <div className="col">
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg tm-social text-secondary">
                      <a href="src/pages/team#">@charlottejohnson</a>
                    </p>
                  </div>
                </div>
              </div>{' '}
              ...
              <div className="col">
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg tm-social text-secondary">
                      <a href="src/pages/team#">@oliviasteiner</a>
                    </p>
                  </div>
                </div>
              </div>{' '}
              ...
              <div className="col">
                <div className="team-member wow fadeInUp">
                  ...
                  <div className="team-member-data">
                    ...
                    <p className="p-lg tm-social text-secondary">
                      <a href="src/pages/team#">@markbrayton</a>
                    </p>
                  </div>
                </div>
              </div>{' '}
                    ...
                    <div className="review-author">
                      <h6 className="h6-lg">
                        ...
                        <span className="text-secondary">
                          <a href="src/pages/team#">Marketing Manager</a>
                        </span>
                      </h6>
                    </div>
                    {/* Text */}
                  ...
                  <div className="review-3-txt">
                    ...
                    <div className="review-author">
                      <h6 className="h6-lg">
                        Joel Peterson
                        <span className="text-secondary">
                          <a href="src/pages/team#">Internet Surfer</a>
                        </span>
                      </h6>
                    </div>
                    {/* Text */}
                  ...
                  <div className="review-3-txt">
                    ...
                    <div className="review-author">
                      <h6 className="h6-lg">
                        Jennifer Harper
                        <span className="text-secondary">
                          <a href="src/pages/team#">App Developer</a>
                        </span>
                      </h6>
                    </div>
                    {/* Text */}
