          ...
          <div className="row d-flex align-items-center">
            ...
            <div className="col-md-7 col-lg-6 order-first order-md-2">
              <div className="txt-block right-column wow fadeInLeft">
                {/* Title */}
                <h2 className="h2-xs">مكالمات ورسائل نصية ورسائل صور غير محدودة</h2>
                {/* Text */}
                <p className="p-lg">
                ...
                <div className="btns-group mb-30">
                  <Link href="/download">
                    <a className="btn btn-orange-red tra-orange-red-hover mr-15">هيا بنا نبدأ</a>
                  </Link>
                  <Link href="/pricing">
                    <a className="btn btn-tra-grey tra-orange-red-hover">عرض التسعير</a>
                  </Link>
                </div>
                {/* Advantages List */}
