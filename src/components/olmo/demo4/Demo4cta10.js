          ...
          <div className="row d-flex align-items-center">
            ...
            <div className="col-lg-8 col-xl-7">
              <div className="cta-10-txt">
                {/* Title */}
                <h3 className="h3-md">{`Get started with OLMO for Free. It's fast and very easy!`}</h3>
                {/* Text */}
                <p className="p-lg">
                  Donec vel sapien augue integer urna vel turpis cursus porta, mauris augue luctus dolor velna auctor
                  congue tempus integer pretium
                </p>
                {/* Button */}
                <Link href="/pricing">
                  <a className="btn btn-pink tra-white-hover">Get Started Now</a>
                </Link>
              </div>
            </div>
