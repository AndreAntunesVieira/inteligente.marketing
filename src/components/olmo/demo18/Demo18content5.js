const Demo18content5 = () => {
  return (
    <section id="content-5" className="content-5 bg-snow ws-wrapper content-section division">
          ...
          <div className="row d-flex align-items-center">
                ...
                <ul className="simple-list">
                  <li className="list-item">
                    <p className="p-lg">
                      ...
                      and quaerat sapien rutrum mauris auctor
                    </p>
                  </li>
                  <li className="list-item">
                    <p className="p-lg">
            ...
            <div className="col-md-5 col-lg-6">
              <div className="img-block right-column wow fadeInLeft">
                <img className="img-fluid" src="/images/seo-01.png" alt="content-image" />
              </div>
            </div>
          </div>
        </div>{' '}
