...
const Demo7content9 = () => {
  return (
    <section id="content-9" className="content-9 pt-100 content-section division">
        ...
        <div className="row justify-content-center">
          <div className="col-md-10 col-lg-8">
            <div className="section-title title-02 mb-60">
              {/* Section ID */}
              <span className="section-id rounded-id bg-tra-purple purple-color txt-upcase">Easy Integration</span>
              {/* Title */}
