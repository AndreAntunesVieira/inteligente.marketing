        ...
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-6 order-last order-md-2">
            <div className="txt-block left-column wow fadeInLeft">
              ...
              {/* Text */}
              <p className="p-lg">
                Quaerat sodales sapien purus blandit a purus ipsum primis in cubilia laoreet augue luctus magna dolor
                luctus egestas sapien vitae blandit and tempor sapien dolores
              </p>
              {/* Text */}
              <p className="p-lg">
                Quaerat sodales sapien euismod undo purus blandit purus cubilia ipsum primis in laoreet augue luctus
                undo magna a dolor luctus sapien vitae a nemo egestas volute
              </p>
            </div>
          </div>{' '}
          {/* END TEXT BLOCK */}
