          ...
          <div className="row justify-content-center">
            <div className="col-md-10 col-lg-8">
              <div className="about-2-title">
                {/* Title */}
                <h2 className="h2-xl">Creativity and quality is our destination</h2>
                {/* Text */}
                <p className="p-xl">
                  Quaerat sodales sapien and euismod blandit vitae ipsum primis cubilia undo laoreet augue luctus magna
                  and dolor luctus egestas sapien
                </p>
              </div>
            </div>
          </div>{' '}
